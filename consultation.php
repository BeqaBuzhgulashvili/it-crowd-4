...
<html lang="en">
	<head>
		<title>ItCrowd - კონსულტაცია</title>
		<meta charset="utf-8">
							...
							<div class="my_cart_wrapper">
								...
								<div class="my_cart_popup">
									<div class="my_cart_buttons">
										<a href="consultation.php?lang=ka"  class="my_cart_button2">ქართული</a>
									 <a href="consultation.php?lang=en" class="my_cart_button2">english</a>
									</div>
								</div>
							</div>
							<nav class="navbar_ navbar navbar-expand-md clearfix">
								...
								<div class="collapse navbar-collapse" id="navbarSupportedContent">
									<ul class="nav navbar-nav sf-menu clearfix">
										...
										<li class="nav-item sub-menu"><a href="#" class="nav-link active"><?php echo $lang['service'] ?><i class="fa fa-caret-down" aria-hidden="true"></i></a>
											<div class="sf-mega">
												<ul>
			...
			<div class="content-wrapper">
				...
				<div class="content-inner">
					<div class="breadcrumbs1_wrapper">
						<div class="container">
							<div class="breadcrumbs1"><a href="index.html"><i class="fa fa-home" aria-hidden="true"></i></a><span>/</span><?php echo $lang['Consultation'] ?></div>
						</div>
					</div>
					<div id="content" class="page-section">
						<div class="container">
							<div class="title1"><span><?php echo $lang['Consultation'] ?></span></div>
							
							<div class="title2"><?php echo $lang['important'] ?></div>
							<br>
							<div class="title3"><?php echo $lang['today'] ?></div>
							<p>
								<?php echo $lang['IT specialist'] ?>
